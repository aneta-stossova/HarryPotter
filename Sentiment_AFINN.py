...
dialogues = pd.read_csv("CSV_raw_data/Tables/Dialogue.csv", encoding="ISO-8859-1")
fact_dialogue = pd.read_csv("CSV_draft/fact_dialogue_afinn_draft.csv", encoding="ISO-8859-1")
